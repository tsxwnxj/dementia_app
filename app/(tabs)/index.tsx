...
const styles = StyleSheet.create({
  ...
  greeting: { fontSize: 34, fontWeight: '700', color: '#212121', marginBottom: 20, textAlign: 'center', letterSpacing: -1 },
  ...
  tipTitle: { fontSize: 20, fontWeight: '700', color: '#000', marginBottom: 10 },
  tipText: { fontSize: 19, color: '#000', lineHeight: 28 },
  ...
  refreshBtn: { fontSize: 16, color: '#fff', fontWeight: '600' },
