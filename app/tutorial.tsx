...
const GESTURES = [
  { name: '손가락 움직이기', desc: '손가락을 천천히 움직여 보세요.', gif: require('../assets/gestures/gesturetest.gif') },
  { name: '손 털기', desc: '손을 가볍게 털어 보세요.', gif: null },
  { name: '손가락 접기', desc: '손가락을 하나씩 접어 보세요.', gif: null },
  { name: '주먹 쥐고 펴기', desc: '주먹을 쥐었다가 펴 보세요.', gif: null },
  { name: '엇갈려 주먹 쥐고 펴기', desc: '양손을 엇갈려 주먹을 쥐었다가 펴 보세요.', gif: null },
  { name: '손끝 박수', desc: '손끝끼리 가볍게 박수를 쳐 보세요.', gif: null },
];
        ...
        <View style={styles.gifBox}>
          {gesture.gif ? (
            ...
            <View style={styles.gifPlaceholder}>
              <Text style={[styles.gifPlaceholderText, { fontSize: 16 * fontScale }]}>
                🎬 GIF 준비 중
              </Text>
            </View>
          )}
...
const styles = StyleSheet.create({
  ...
  skipText: { color: '#2D6A4F', fontWeight: '600' },
  ...
  gifImage: { width: 240, height: 440, borderRadius: 24 },
  gifPlaceholder: {
    width: 240, height: 240, backgroundColor: '#fff', borderRadius: 24,
    justifyContent: 'center', alignItems: 'center',
    shadowColor: '#000', shadowOffset: { width: 5, height: 5 }, shadowOpacity: 0.1, shadowRadius: 6, elevation: 5,
  },
  gifPlaceholderText: { color: '#9E9E9E', fontWeight: '600' },
  infoBox: {
    borderRadius: 20, padding: 20, alignItems: 'center', marginBottom: 16,
    shadowColor: '#000', shadowOffset: { width: 5, height: 5 }, shadowOpacity: 0.1, shadowRadius: 6, elevation: 5,
  },
  gestureName: { fontWeight: '700', color: '#4DA56F', marginBottom: 8, textAlign: 'center' },
  gestureDesc: { color: '#4DA56F', textAlign: 'center', lineHeight: 26 },
